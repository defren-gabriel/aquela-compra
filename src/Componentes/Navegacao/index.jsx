    ...
    return(
        <header className={styles.header}>
            <div className={styles.dev}>
                <a className={styles.deva} href="https://github.com/defren-gabriel/aquela-compra" target="_blank">Link do Projeto</a>
                <a className={styles.deva} href="https://github.com/defren-gabriel" target="_blank">Link do DeFrEn</a>
            </div>
            <nav className={styles.nav}>
                <div className={styles.container1}>
                    <span className={styles.container1s}>Aquela Compra</span>
                    <Link className={styles.container1a} to={"/"} style={{display: estaLista ? "none" : "block"}} disabled={estaLista}>Início</Link>
                    <Link className={styles.container1a} to={"/lista"} style={{display: estaInicio ? "none" : "block"}} disabled={estaInicio} >Compras</Link>
                </div>
